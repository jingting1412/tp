...
with(this){return _c('ol',[_c('li',[_v("Help can be called anytime and has no format to follow. The popup screen is disabled to avoid confusion but can be enabled in the future if need be.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("JAR file")]),_v(": A package file format that bundles all the components of a Java application into a single file for distribution.")]),_v(" "),_c('li',[_c('strong',[_v("Command Line Interface (CLI)")]),_v(": A means for users to interact with a software by inputting commands")]),_v(" "),_c('li',[_c('strong',[_v("Human editable text file")]),_v(": A text file that can be viewed and modified using a standard text editor by a user.\n(e.g. a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v(".txt")]),_v(" file)")]),_v(" "),_c('li',[_c('strong',[_v("Graphical User Interface (GUI)")]),_v(": A type of user interface that allows users to interact with software through\ngraphical icons and visual indicators.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 26 Oct 2023, 15:16:31 GMT+8]")])])])}
}];
